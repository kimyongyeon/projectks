...
public class FAQ extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.admission_faq_menu);
		Intro.gubunView = 4;
		lv = (ListView)findViewById(R.id.admission_faq_menu_lv01);
		
		/*t = new TitleDTO();
		t.title = getResources().getString(R.string.faq0);
		ar.add(t);*/
		t = new TitleDTO();
		t.title = getResources().getString(R.string.faq1);
		ar.add(t);
		t = new TitleDTO();
		t.title = getResources().getString(R.string.faq2);
		ar.add(t);
		t = new TitleDTO();
		t.title = getResources().getString(R.string.faq3);
		ar.add(t);
		t = new TitleDTO();
		t.title = getResources().getString(R.string.faq4);
		ar.add(t);
		t = new TitleDTO();
		t.title = getResources().getString(R.string.faq5);
		ar.add(t);
		t = new TitleDTO();
		t.title = getResources().getString(R.string.faq6);
		ar.add(t);
	...
	class LifeListAdapter extends BaseAdapter {
		...
		public View getView(int position, View v, ViewGroup parent) {
			...
			if (v == null) {
				v = inflater.inflate(
						R.layout.admission_faq_menu_row, parent,
						false);
			}

			//ImageView lv_img1 = (ImageView)v.findViewById(R.id.LifeRow_Iv01);
			TextView tv_str1 = (TextView) v.findViewById(R.id.admission_faq_menu_row_tv01);
